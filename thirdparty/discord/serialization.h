...
// Commands
size_t JsonWriteRichPresenceObj( char* dest, size_t maxLen, int nonce, int pid, const Discord::RichPresence& presence );
...
public:
	...
	void* Realloc( void* originalPtr, size_t originalSize, size_t newSize )
	{
		...
		NOTE_UNUSED( originalPtr );
		NOTE_UNUSED( originalSize );
...
static constexpr size_t WriterNestingLevels = 2048 / ( 2 * sizeof( size_t ) );
