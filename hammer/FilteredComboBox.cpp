...
BEGIN_MESSAGE_MAP(CFilteredComboBox, CComboBox)
	...
	ON_CONTROL_REFLECT_EX(CBN_SELCHANGE, &ThisClass::OnSelChange)
	ON_CONTROL_REFLECT_EX(CBN_EDITCHANGE, &ThisClass::OnEditChange)
	ON_CONTROL_REFLECT_EX(CBN_CLOSEUP, &ThisClass::OnCloseUp)
	ON_CONTROL_REFLECT_EX(CBN_DROPDOWN, &ThisClass::OnDropDown)
	ON_CONTROL_REFLECT_EX(CBN_SELENDOK, &ThisClass::OnSelEndOK)
	ON_WM_CTLCOLOR()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
