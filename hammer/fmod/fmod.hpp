    ...
    */
    class System
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a System class.  System_Create must be used.
        System() = delete;
    ...
    */
    class Sound
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a Sound class.  Appropriate Sound creation or retrieval function must be used.
        Sound() = delete;
    ...
    */
    class ChannelControl
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a Control class.
    ...
    */
    class Channel : public ChannelControl
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a Channel class.  Appropriate Channel creation or retrieval function must be used.
        Channel() = delete;
    ...
    */
    class ChannelGroup : public ChannelControl
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a ChannelGroup class.  Appropriate ChannelGroup creation or retrieval function must be used.
        ChannelGroup() = delete;
    ...
    */
    class SoundGroup
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a SoundGroup class.  Appropriate SoundGroup creation or retrieval function must be used.
        SoundGroup() = delete;
    ...
    */
    class DSP
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a DSP class.  Appropriate DSP creation or retrieval function must be used.
        DSP() = delete;
    ...
    */
    class DSPConnection
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a DSPConnection class.  Appropriate DSPConnection creation or retrieval function must be used.
        DSPConnection() = delete;
        DSPConnection(const DSPConnection&) = delete;
    ...
    */
    class Geometry
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a Geometry class.  Appropriate Geometry creation or retrieval function must be used.
        Geometry() = delete;
    ...
    */
    class Reverb3D
    {
      public:
        ...
        // Constructor made deleted so user cannot statically instance a Reverb3D class.  Appropriate Reverb creation or retrieval function must be used.
        Reverb3D() = delete;
        Reverb3D(const Reverb3D&) = delete;
