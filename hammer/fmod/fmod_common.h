...
typedef struct FMOD_OUTPUT_DESCRIPTION FMOD_OUTPUT_DESCRIPTION;
typedef struct FMOD_DSP_PARAMETER_DESC FMOD_DSP_PARAMETER_DESC;
typedef struct FMOD_DSP_METERING_INFO  FMOD_DSP_METERING_INFO;
