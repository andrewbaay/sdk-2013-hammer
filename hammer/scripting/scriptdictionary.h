...
public:
	...
	CScriptArrayT<ScriptString>* GetKeys() const;

	using dictMap_t = robin_hood::unordered_node_map<dictKey_t, AS_NAMESPACE_QUALIFIER CScriptDictValue>;
