...
struct ScriptDocumentationOptions
{
	...
	const char*		asEnumTypeColor = "#90cc00";						// CSS color spec for enum types in displayed AngelScript code
	const char*		asEnumValueColor = "#cc9700";						// CSS color spec for enum values in displayed AngelScript code
