...
#include "spritee_vs20.inc"
#include "spritee_ps20b.inc"
...
BEGIN_SHADER( Sprite_DX9, "Help for Sprite_DX9" )
	BEGIN_SHADER_PARAMS
...
#define SHADER_USE_CONSTANT_COLOR	2
	...
	void SetSpriteCommonShadowState( unsigned int shaderFlags )
	{
		...
		DECLARE_STATIC_VERTEX_SHADER( spritee_vs20 );
		...
		pShaderShadow->SetVertexShader( "sprite_vs20", _vshIndex.GetIndex() );

		DECLARE_STATIC_PIXEL_SHADER( spritee_ps20b );
		...
		pShaderShadow->SetPixelShader( "sprite_ps20b", _pshIndex.GetIndex() );
	...
	void SetSpriteCommonDynamicState( unsigned int shaderFlags )
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER( spritee_vs20 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( DOWATERFOG,  fogIndex );
		SET_DYNAMIC_VERTEX_SHADER( spritee_vs20 );

		DECLARE_DYNAMIC_PIXEL_SHADER( spritee_ps20b );
		SET_DYNAMIC_PIXEL_SHADER_COMBO( HDRENABLED, IsHDREnabled() );
		SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
		SET_DYNAMIC_PIXEL_SHADER( spritee_ps20b );
