...
DECLARE_BUILD_FACTORY_DEFAULT_TEXT( CvarToggleCheckButton, CvarToggleCheckButton );

BEGIN_PANEL_SETTINGS( CvarToggleCheckButton )
	{ "cvar_name", TYPE_STRING },
	{ "cvar_value", TYPE_STRING }
END_PANEL_SETTINGS( CvarToggleCheckButton );
