...
namespace vgui
{
	...
	{
		DECLARE_CLASS_SIMPLE( GripPanel, Panel );
	public:
	...
	{
		DECLARE_CLASS_SIMPLE( CaptionGripPanel, GripPanel );
	public:
...
namespace vgui
{
	...
	{
		DECLARE_CLASS_SIMPLE( FrameButton, Button );
	private:
